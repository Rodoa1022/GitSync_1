...
class NewCaseBuilder(object):
    ...
    def create_case(self, prefix=None, is_original_mail=False, additional_events=[]):
        """
...
class EmailConnector(BaseEmailConnector):
    ...
    def _initialize_managers(self):
        ...
        print(self.username,">>>"+self.password+"<<<",self.imap_host,self.imap_use_ssl)
    ...
    def _create_case_info(self, email, is_original_mail=False, additional_events=[]):
        """
